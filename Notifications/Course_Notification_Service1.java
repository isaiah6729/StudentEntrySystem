...
import Courses.CoursesDetailPage;

public class Course_Notification_Service1 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        AlertsObject.deleteAlerts();
        database.readalerts(todaysDate);
        ...
        notificationManager.createNotificationChannel(channel);
            ...
            for (int i = 0; i < AlertsObject.getAllAlerts().size(); ++i) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "getnotification")
                        ...
                        .setContentText(AlertsObject.getAllAlerts().get(i).getAlerts())
