...
public class Assessment_Notification_Service3 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
            ...
            if ( database.readPerformanceassessmentsDates(todaysDate)) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(context, "notification")
                        ...
                        .setContentText("You have a Performance assessment that starts today!")
